...
router.get(
  "/login",
  identityController.googleLogin
);
...
router.get(
  "/callback",
  identityController.googleCallback
);

router.get(
  "/onboarding/status",
  identityController.onboardingStatus
);
...
router.post(
  "/account",
  identityController.createAccount
);
...
router.delete(
  "/account",
  requireAuth,
  identityController.deleteAccount
);
