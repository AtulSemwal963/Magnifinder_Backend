 ...
 */
router.post("/", requireAuth, (req, res, next) => credentialsController.createCredential(req, res, next));
/**
 ...
 */
router.get("/", requireAuth, (req, res, next) => credentialsController.getCredentials(req, res, next));
/**
 ...
 */
router.get("/:provider", requireAuth, (req, res, next) => credentialsController.getCredential(req, res, next));
/**
 ...
 */
router.patch("/:provider", requireAuth, (req, res, next) => credentialsController.updateCredential(req, res, next));
/**
 ...
 * to the authenticated user.
 */
router.delete("/:provider", requireAuth, (req, res, next) => credentialsController.deleteCredential(req, res, next));
