...
export class LeadRepository {
     ...
     */
    async findManyBySearchId(searchId) {
     ...
     */
    async *streamBySearchId(searchId) {
        let cursorId;
        while (true) {
     ...
     */
    async findByIdAndSearchId(leadId, searchId) {
     ...
     */
    async deleteManyBySearchId(searchId) {
